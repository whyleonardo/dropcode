...
export const FileItem = ({ file, snippetSlug }: FileItemProps) => {
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <Link href={`/snippets/${snippetSlug}/file/${file.publicId}`}>
          <DropFileTrigger active={pathname.includes(file.publicId)}>
