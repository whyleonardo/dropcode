...
export const Icons = {
  ...
  logo: (props: LucideProps) => (
    ...
    >
      <mask
        ...
        height="64"
      >
        <rect x="0.453857" width="64" height="64" rx="32" fill="white" />
      </mask>
      <g mask="url(#mask0_111_62)">
        <path
          d="M-2.564 3.1108C-2.56479 1.98198 -1.65034 1.06689 -0.521529 1.06689L30.2773 1.06689C48.5395 1.06689 63.3543 15.8714 63.3671 34.1336V34.1336C63.3799 52.3958 48.5858 67.2002 30.3236 67.2002H-0.475237C-1.60405 67.2002 -2.51978 66.2851 -2.52057 65.1563L-2.564 3.1108Z"
          className="fill-foreground"
        />
        <path
          d="M-3.23047 6.42517L30.2264 6.42517C45.4069 6.42517 57.7199 18.7314 57.7283 33.9119V33.9119C57.7367 49.0924 45.4373 61.3986 30.2569 61.3986H-3.20003L-3.23047 6.42517Z"
          className="fill-background"
        />
        <path
          d="M-0.0622559 11.937H29.662C41.4564 11.937 51.0232 21.4982 51.0302 33.2926V33.2926C51.0371 45.0869 41.4816 54.6481 29.6872 54.6481H-0.0370314L-0.0622559 11.937Z"
          className="fill-foreground"
        />
        <path
          d="M-2.76904 16.5844H27.8805C37.0074 16.5844 44.4107 23.9832 44.4161 33.1101V33.1101C44.4215 42.2371 37.027 49.6359 27.9 49.6359H-2.74952L-2.76904 16.5844Z"
          className="fill-background"
        />
        <path
          d="M1.68457 21.4681H25.9862C32.4118 21.4681 37.6238 26.6771 37.6276 33.1027V33.1027C37.6314 39.5283 32.4255 44.7373 25.9999 44.7373H1.69831L1.68457 21.4681Z"
          className="fill-foreground"
        />
        <path
          d="M-2.56421 26.3668H25.5353C29.2554 26.3668 32.2729 29.3825 32.2751 33.1026V33.1026C32.2773 36.8227 29.2633 39.8384 25.5432 39.8384H-2.55625L-2.56421 26.3668Z"
          className="fill-background"
        />
      </g>
    </svg>
  ...
  go: (props: LucideProps) => (
    <svg
      ...
      {...props}
    >
      <g className="fill-foreground" fill-rule="evenodd">
  ...
  json: (props: LucideProps) => (
    ...
    >
      <path
        d="M23.898,13.566c0.149-1.16,0.135-2.346-0.045-3.499c-0.149-0.96-0.42-1.896-0.795-2.788c-0.241-0.561-0.526-1.101-0.856-1.617c-1.171-1.837-2.868-3.314-4.822-4.301c-0.695-0.355-1.427-0.645-2.178-0.869h-0.005c0.119,0.063,0.241,0.132,0.346,0.201c0.12,0.074,0.24,0.146,0.352,0.225c0.57,0.385,1.097,0.827,1.563,1.33c1.066,1.145,1.802,2.548,2.224,4.041c0.285,0.982,0.435,1.998,0.496,3.017c0.044,0.743,0.044,1.491-0.047,2.229c-0.149,1.27-0.555,2.51-1.231,3.596c-0.496,0.803-1.143,1.519-1.908,2.084c-1.247,0.928-2.884,1.482-4.447,1.114c-0.255-0.061-0.511-0.146-0.75-0.258c-0.272-0.124-0.541-0.277-0.781-0.449c-0.466-0.311-0.887-0.685-1.247-1.106c-0.436-0.52-0.796-1.111-1.052-1.747c-0.315-0.806-0.48-1.672-0.495-2.54c-0.03-1.273,0.226-2.553,0.856-3.67c0.421-0.744,0.991-1.396,1.667-1.918c0.226-0.178,0.465-0.333,0.706-0.479l0.016-0.007c-0.467-0.105-0.962-0.151-1.445-0.12C9.601,6.064,9.195,6.14,8.789,6.274c-0.36,0.12-0.706,0.271-1.022,0.45C7.512,6.873,7.258,7.039,7.033,7.219c-0.212,0.18-0.421,0.359-0.617,0.555C5.29,8.927,4.644,10.456,4.389,12.03c-0.151,0.973-0.151,1.961-0.091,2.951c0.105,1.394,0.392,2.786,0.947,4.061c0.345,0.794,0.795,1.527,1.351,2.173c0.856,0.987,1.939,1.753,3.14,2.231c0.677,0.271,1.397,0.465,2.118,0.54C11.929,24,12.004,24,12.064,24l-0.021-0.032c0.48-0.004,0.955-0.029,1.429-0.094c1.083-0.138,2.148-0.433,3.154-0.863c1.413-0.602,2.705-1.471,3.803-2.543c1.005-0.989,1.847-2.151,2.446-3.427C23.386,15.944,23.746,14.767,23.898,13.566z"
        className="fill-foreground stroke-background"
      />
      <path
        d="M0.104,13.576c0.12,1.02,0.375,2.023,0.78,2.977c0.228,0.57,0.512,1.124,0.827,1.648c1.097,1.783,2.69,3.236,4.521,4.24c0.69,0.391,1.412,0.69,2.162,0.945c0.227,0.074,0.451,0.149,0.691,0.209l0.016-0.024c-0.164-0.07-0.315-0.149-0.451-0.228c-0.149-0.083-0.301-0.168-0.45-0.259c-0.587-0.362-1.111-0.787-1.593-1.275c-1.097-1.138-1.831-2.567-2.253-4.081c-0.285-1.034-0.436-2.102-0.496-3.172c-0.044-0.703-0.029-1.393,0.046-2.082c0.135-1.257,0.496-2.501,1.127-3.58C5.482,8.1,6.097,7.396,6.819,6.841c0.495-0.374,1.052-0.69,1.637-0.9c0.826-0.299,1.712-0.389,2.569-0.27c0.331,0.045,0.66,0.121,0.961,0.225c0.029,0,0.029,0,0.045,0.03c0.015,0.015,0.045,0.015,0.06,0.03c0.045,0.016,0.104,0.045,0.165,0.074c0.24,0.12,0.48,0.271,0.706,0.42c0.901,0.629,1.637,1.498,2.102,2.502c0.421,0.914,0.617,1.934,0.633,2.938c0.014,1.079-0.181,2.157-0.647,3.146c-0.556,1.184-1.502,2.188-2.645,2.832c0.09,0.03,0.181,0.045,0.272,0.075c0.226,0.044,0.45,0.074,0.69,0.074c1.472,0.045,2.899-0.659,3.95-1.647c0.195-0.18,0.376-0.375,0.541-0.585c0.225-0.27,0.436-0.539,0.615-0.823c0.24-0.375,0.436-0.75,0.616-1.154c0.227-0.539,0.405-1.094,0.51-1.664c0.196-1.004,0.212-2.022,0.149-3.026c-0.135-2.022-0.675-4.045-1.847-5.724c-0.181-0.254-0.36-0.494-0.556-0.719c-0.33-0.375-0.691-0.719-1.066-1.034c-0.421-0.345-0.887-0.659-1.366-0.915c-0.494-0.223-1.081-0.447-1.696-0.598l-0.301-0.06c-0.21-0.03-0.421-0.044-0.636-0.06c-0.326-0.015-0.671-0.01-1.018,0.016c-0.706,0.045-1.416,0.16-2.117,0.337C5.783,1.227,2.84,3.566,1.273,6.669C0.771,7.658,0.416,8.715,0.209,9.801C-0.031,11.044-0.062,12.324,0.104,13.576z"
        className="fill-foreground stroke-background"
      />
    </svg>
  ),
